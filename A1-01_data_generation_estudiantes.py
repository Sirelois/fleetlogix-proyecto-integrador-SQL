...
class DataGenerator:
    ...
    def generate_vehicles(self, count=200):
        ...
        # Insertar en batch
        query = """
            INSERT INTO vehicles (license_plate, vehicle_type, capacity_kg, fuel_type,
    ...
    def generate_deliveries(self, count=400000):
        ...
        for trip_id, departure, arrival, total_weight, city in tqdm(trips_data, desc="Generando deliveries"):
            ...
            for i in range(num_deliveries):
                ...
                package_weight = float(np.float64(weights[i]))
    ...
    def generate_maintenance(self, count=5000):
        ...
        self.cursor.execute("""
            SELECT v.vehicle_id, v.vehicle_type, COUNT(*) as trip_count, 
